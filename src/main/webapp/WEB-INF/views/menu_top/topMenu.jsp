...
<!-- /.navbar-header -->
	...
	<div class="buttons">
		<div class="middle">
		<a href="/changelocale/fr" class="hero_btn red_btn">Français</a>
		<a href="/changelocale/en" class="hero_btn red_btn">English</a>
	</div>
	
	<div class="right">
		<a href="/logout" class="hero_btn red_btn"><fmt:message code="logout.top"/></a>
	</div>
	</div>
