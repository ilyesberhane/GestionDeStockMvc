                                	...
                                	<c:forEach items="${commandesClient }" var = "cde">
                                		<tr>
	                                		...
	                                		<td>${cde.getTotalCommande() }</td>
	                               			<td>
	                               				<textArea id = "json${cde.getId() }" style="display: none;">${cde.getLigneCommandeJson() }  </textArea>
	                               				
	                                        	<button class="btn btn-link" onclick="updateDetailCommande(${cde.getId() });"><i class="fa fa-th-list"></i></button>
	                                        	&nbsp;|&nbsp;
	                                        	<c:url value="/commandeclient/modifier/${cde.getId() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalcommande${cde.getId() }"><i class="fa fa-trash-o"></i></a>
	                                        	
	                                        	<div class="modal fade" id="modalcommande${cde.getId() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/commandeclient/supprimer/${cde.getId() }" var="urlSuppression" />
